      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        {!reachedLimit && (
          <button
            ...
            className="flex h-16 w-16 items-center justify-center rounded border-2 border-dashed border-gray-300 text-xs text-gray-500 hover:border-red-500 hover:text-red-500 disabled:opacity-50"
          >
            {uploading ? "上傳中..." : `📷 加照片`}
          </button>
        )}
